...
export function InvoiceA4({ order, setting, adminName }: Props) {
  return (
    <div
      className="mb-6 page-break bg-white text-black"
      ...
      <div className="border border-gray-300 rounded-sm overflow-hidden">
        ...
        <div className="flex justify-between items-start px-6 py-4 border-b-2 border-gray-800">
          ...
          <div className="text-right">
            <p className="text-[16px] font-bold tracking-wider text-gray-800">
              INVOICE
            </p>
          ...
          >
            <thead>
              <tr className="border-b-2 border-gray-800">
                <th className="text-left py-2 pr-2 font-bold text-[9px] uppercase tracking-wider text-gray-600">
                  Produk
                </th>
                <th className="text-center py-2 px-2 font-bold text-[9px] uppercase tracking-wider text-gray-600">
                  Qty
                </th>
                <th className="text-right py-2 px-2 font-bold text-[9px] uppercase tracking-wider text-gray-600">
                  Harga
                </th>
                <th className="text-right py-2 pl-2 font-bold text-[9px] uppercase tracking-wider text-gray-600">
                  Subtotal
                </th>
              </tr>
            </thead>
